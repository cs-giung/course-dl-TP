...
* **Adversarial Machine Learning at Scale** <br>
  *Alexey Kurakin, Ian Goodfellow, Samy Bengio* <br>
...
<p align="center">
    <img width=25% src="./md/atn_plot_eps8/plot_std.png"><img width=25% src="./md/atn_plot_eps8/plot_fgsm.png"><img width=25% src="./md/atn_plot_eps8/plot_pgd.png"><img width=25% src="./md/atn_plot_eps8/plot_atn.png">
</p>

#### eps=12/255

<p align="center">
    <img width=25% src="./md/atn_plot_eps12/plot_std.png"><img width=25% src="./md/atn_plot_eps12/plot_fgsm.png"><img width=25% src="./md/atn_plot_eps12/plot_pgd.png"><img width=25% src="./md/atn_plot_eps12/plot_atn.png">
</p>
